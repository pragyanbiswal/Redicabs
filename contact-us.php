...
<title>RediCabs| Contact Us Page</title>
<!--Bootstrap -->
...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-8" style="padding-left: 134px;">
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            <div class="form-group">
              ...
              <input type="text" name="fullname" class="form-control white_bg" id="fullname" pattern="[a-z]{1,15}" title="Username should only contain lowercase letters. e.g. john" required>
            </div>
            <div class="form-group">
              <label class="control-label">Email Address <span>*</span></label>
              <input type="email" name="email" class="form-control white_bg" id="emailaddress"  title="Contact's email (format: xxx@xxx.xxx)" 
...
<!-- /Contact-us--> 
 <div class="contact-page-map-wrapper">
            <div class="map" id="map" ><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3741.031699530523!2d85.8217749149212!3d20.340309086375385!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a1909316c365829%3A0x716b03f5dc8bbb58!2sIntelCorp%20Solutions%20Pvt%20Ltd.!5e0!3m2!1sen!2sin!4v1631619223084!5m2!1sen!2sin" width="1350" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></div>
        </div>
