...
$sql="update tblvehicles set ownname=:ownname,ContactNo=:ContactNo,email=:email,vehno=:vehno,vehreg=:vehreg,vehchas=:vehchas, VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,VehiclesOverview=:vehicleoverview,PricePerDay=:priceperday,FuelType=:fueltype,ModelYear=:modelyear,SeatingCapacity=:seatingcapacity,AirConditioner=:airconditioner,PowerDoorLocks=:powerdoorlocks,AntiLockBrakingSystem=:antilockbrakingsys,BrakeAssist=:brakeassist,PowerSteering=:powersteering,DriverAirbag=:driverairbag,PassengerAirbag=:passengerairbag,PowerWindows=:powerwindow,CDPlayer=:cdplayer,CentralLocking=:centrallocking,CrashSensor=:crashcensor,LeatherSeats=:leatherseats where id=:id ";
...
<div class="col-sm-4">
<input type="text" name="ownname" class="form-control" value="<?php echo htmlentities($result->ownname)?>" required>
</div>	
<div class="form-group">
...
<div class="col-sm-4">
<input type="text" name="vehno" class="form-control" value="<?php echo htmlentities($result->vehno)?>" required>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">VehicleRegNo<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehreg" class="form-control" value="<?php echo htmlentities($result->vehreg)?>" required>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">VehicleTitle<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="VehiclesTitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
